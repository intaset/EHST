...
<title>EHST'18 - Contact Us</title>
 ...
 <div class="unit unit-s-3-4 unit-m-3-4 unit-l-3-4">
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      ...
      <p class="body">EHST 2018 will  be held in Niagara Falls, Canada on June 7 - 9, 2018.</p></p>

      <!-- <p class="bold">EHST'18 Workshop</p>
      <p class="body">As per popular request, the organizing committee has decided to extend the EHST'18 conference to three days (now June 7 - 9, 2018). The new high-level schedule is as follows:</p>
    ...
    <div>
      ...
      <p class="body">EHST attracts a wide range of researchers in the field of energy harvesting, storage, and transfer. As a prominent company in the field of energy harvesting, storage, and transfer, we would like to offer you an exhibit at EHST. Please visit <a href="../sponsor" class="body-link">Sponsors</a> for more information.</p>
    </div>
  </div>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  <div class="unit-spacer content">
    ...
    Thank you for your interest in EHST'18.</p>
  </div>
</div>
